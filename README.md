...
<p align="center">
  ...
  <h3 align="center">Extension Renderer</h3>
</p>
...
EXTENSION IS IN ALPHA VERSION
This extension is a simple script to manage your renderer area easily.
There is only one method for now in this extension.
...
in Unity : Windows -> Package Manager -> + -> Add package from git url
2. Clone the repo
3. The extension is static so you can call it wherever you are in your project.
4. Enjoy !
